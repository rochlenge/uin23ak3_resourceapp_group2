function ResourceArticles({ resources }) {
  ...
  // For hver ressurs, legges den til i et nytt array for kategorien, som opprettes i acc-objektet hvis den ikke allerede finnes.
  const resourcesByCategory = resources.reduce((acc, curr) => {
